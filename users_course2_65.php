...
<body>
    <div class="container my-4">
                ...
                <form action="" method="get" class="">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <input type="number" id="minValue" placeholder="請輸入查詢價格。" name="minValue" class="form-control " value="<?= $minValue ?>">
                        </div>
                        <div class="d-flex align-items-center">
                            <label for="maxValue" class="form-label fw-semibold  w-50">最高價格</label>
                            <input type="number" id="maxValue" placeholder="請輸入查詢價格。" name="maxValue" class="form-control" value="<?= $maxValue ?>">
                        </div>
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="ps-3"><?= "共 $allCourseCount 張優惠卷" ?></div>
